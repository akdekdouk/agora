    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold text-gray-900 mb-4">
          Active Offers <span className="text-gray-400 font-normal text-base">({activeOffers.length})</span>
        </h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-gray-900 mb-4">
          Products <span className="text-gray-400 font-normal text-base">({merchant.products.length})</span>
        </h2>
